 ...
 * Copyright: (c) 2009 Tomasz Gloc (http://jtemplates.tpython.com)
...
$language_data = array (
	...
	'KEYWORDS' => array(
		1 => array(
			'#template', '#foreach', '#for', '#if', '#else', '#elseif', '#include', '#param', '#cycle', '#ldelim', '#rdelim', '#literal', 'as', '#continue', '#break'
			),
		2 => array(
