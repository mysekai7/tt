...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
	<head>
		...
		<link href="<?= $C->SITE_URL ?>themes/facebookish/css/inside.css?v=<?= $C->VERSION ?>" type="text/css" rel="stylesheet" />
		<script type="text/javascript" src="<?= $C->SITE_URL ?>themes/facebookish/js/inside.js?v=<?= $C->VERSION ?>"></script>
		<script type="text/javascript" src="<?= $C->SITE_URL ?>themes/facebookish/js/inside_autocomplete.js?v=<?= $C->VERSION ?>"></script>
		<script type="text/javascript" src="<?= $C->SITE_URL ?>themes/facebookish/js/inside_postform.js?v=<?= $C->VERSION ?>"></script>
		<script type="text/javascript" src="<?= $C->SITE_URL ?>themes/facebookish/js/inside_posts.js?v=<?= $C->VERSION ?>"></script>
		...
		<div id="fbhdr">
			<div id="fbhdr2">	
				...
				<div id="fbnav">	
					...
					<?php } ?> 			
					<a href="<?= $C->SITE_URL ?>" class="<?= $this->request[0]=='dashboard'||$this->request[0]=='home'?'onnav':'' ?>"><b><?= $this->lang('hdr_nav_home') ?></b></a>	
				</div>
			</div>
		</div>
		<div id="whiterow">
