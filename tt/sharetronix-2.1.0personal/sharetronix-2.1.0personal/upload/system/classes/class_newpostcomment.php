		...
		public function save()
		{
			...
			if( $is_private ) {
				...
				if( $n==1 || $n==3 ) {
					...
					$message_htm	= $page->lang('emlhtml_ntf_me_if_u_posts_prvmsg', $lng_htm, $ulng).'<br /><br /> "'.$this->message.'"';
				...
				if( $n == 1 ) {
					...
					foreach($notify as $uid=>$n) {
						...
						if( $n == 3 || $n == 1 ) {
							...
							$message_htm	= $page->lang('emlhtml_ntf_me_if_'.$notifkey, $lng_htm, $ulng).'<br /><br /> "'.$this->message.'"';
