...
$lang = array (
  'api_doc_page_title' => 'Documentación da API - #SITE_TITLE#',
  'api_doc_menu_title' => 'Documentación da API',
  'api_doc_cat_num' => '16',
  'api_doc_cat_1' => 'Comenzando',
  'api_doc_cat_2' => 'OAuth FAQ',
  'api_doc_cat_3' => 'Métodos de Estado',
  'api_doc_cat_4' => 'Métodos de Usuarios',
  'api_doc_cat_5' => 'Mensaxes Directas',
  'api_doc_cat_6' => 'Métodos de Amizade',
  'api_doc_cat_7' => 'Métodos Sociáis',
  'api_doc_cat_8' => 'Métodos da Conta',
  'api_doc_cat_9' => 'Métodos de Grupos',
  'api_doc_cat_10' => 'Métodos de Favoritos',
  'api_doc_cat_11' => 'Búsquedas Gardadas',
  'api_doc_cat_12' => 'Métodos de OAuth',
  'api_doc_cat_13' => 'Usando os Datos do Usuario',
  'api_doc_cat_14' => 'Proba',
  'api_doc_cat_15' => 'Buscar',
  'api_doc_cat_16' => 'Tendencias',
  'api_doc_cant_understand' => 'Aínda non entendes nada? Podes sempre pedirnos o noso apoio.',
  'api_doc_contact_us' => 'Contacta connosco',
  'api_doc_cat_1_post_num' => '8',
  'api_doc_cat_1_post_1_title' => 'Descrición xeral da API de #SITE_TITLE#',
  'api_doc_cat_1_post_1_text' => 'A [b]API de #SITE_TITLE# [/b] está inspirada na [b]API de Twitter�s[/b] e dálle unha forma sinxela e estruturada para acceder aos recursos poderosos de [b]#SITE_TITLE#[/b]. A API permite a busca programada, recuperar, crear e destruír perfil dos usuarios rexistrados, grupos e outros datos do noso sitio web. A capacidade da nosa API permite engadir dinamicamente novos contidos, así como actualizacións de estado, comentar sobre estados existentes, xestionar perfis dos usuarios, grupos, mensaxes directas, favoritos, tendencias e Procura Directa na base de datos de [b]#SITE_TITLE#[/b]. A API está baseada en estándares abertos como son o XML, RSS, JSON e Atom.',
  'api_doc_cat_1_post_2_title' => 'Autenticación',
  'api_doc_cat_1_post_2_text' => 'Non todas as funcionalidades ofrecida polo noso API require autenticación. Funcións con acceso gratuíto son aqueles que todos poden acceder libremente e isto non inclúe as opcións de modificación, como borrar, editar, engadido de datos e lectura de datos persoais dos usuarios.

A API ten algúns métodos que esixen que o usuario se rexistre para acceder e/ou publicar os datos. Por exemplo, a funcionalidade, en [b]#SITE_TITLE#[/b] dispoñible para os usuarios, tales como a presentación de actualizacións ou baixar mensaxes directas, son igualmente protexidas a través da API. Co fin de protexer os datos dos nosos usuarios usase o protocolo OAuth para entrar o acceso a aplicacións para os datos dos usuarios.',
...
OAuth é un mecanismo de paso de Token que permite aos usuarios controlar as aplicacións teñan acceso aos seus datos sen revelar as súas claves. Máis información sobre a especificación OAuth pode atoparse en [url=http://www.oauth.net]oauth.net[/url] ou no Guía do Iniciante excelente para OAuth de [url=http://hueniverse.com/oauth/]Hueniverse[/url].

As inscricións para solicitudes de OAuth en [b]#SITE_TITLE#[/b] está dispoñible en  [url=#SITE_URL#api]#SITE_URL#api[/url].

Os mostras de acceso nunca debe rematar. Un Token de acceso do usuario será anulado se o usuario explicitamente revoga autorización da súa aplicación ou se [b]#SITE_TITLE#[/b] suspende a súa aplicación. Se a súa aplicación está suspendida, haberá unha nota na súa páxina de solicitude dicindo que foi suspendida. En ambos os casos, a aplicación debe ser capaz de manexar revogación Token correctamente.

Moitos usuarios confian nunha aplicación para ler a súa información, pero non necesariamente cambiar o seu nome ou publicar novos estados. Os permisos son OAuth granulados, permitindo que aplicacións e usuarios acordan só lectura ou acceso de lectura-gravación. Actualizar a información a través da API, sexa nome, localización ou engadir a actualización de estado, require un POST HTTP. Calquera método de API que require un POST HTTP é considerado un método de gravación e require acceso de lectura-gravación.',
  'api_doc_cat_1_post_4_title' => 'Clientes de Escritorio',
