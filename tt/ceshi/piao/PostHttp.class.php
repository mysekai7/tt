...
class PostHttp
{
	...
	*/
	...
	{
		if(!$sInfo = $this->parseRequest($sURL))
			return false;
		...
		$httpHeader .= "User-Agent: PostHttp/1.5 (phpsea1.5 by xianqing@gmail.com)\r\n";
		...
		if(!$this->theData = $this->downloadData($host, $port, $httpHeader)) // envia os dados para o servidor
			return false;
	...
	*/
	function post_log()
	{
		...
		$sMonth = date("Ym",time());
		$sTodayDir = DEVKIT_DEBUG_DIR."/".$sMonth;
