<?php /* Smarty version 2.6.26, created on 2010-03-28 17:44:00
         compiled from /home/wangchao/www/blog/templates/default/post.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', '/home/wangchao/www/blog/templates/default/post.html', 27, false),)), $this); ?>
<?php echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh" lang="zh" dir="ltr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="generator" content="blog.sk80.com" /><meta name="keywords" content="'; ?><?php echo $this->_tpl_vars['post']->title; ?><?php echo ':'; ?><?php echo $this->_tpl_vars['post']->category; ?><?php echo ','; ?><?php $_from = $this->_tpl_vars['post']->tags; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['tag_keyword'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['tag_keyword']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['tag']):
        $this->_foreach['tag_keyword']['iteration']++;
?><?php echo ''; ?><?php echo $this->_tpl_vars['tag']; ?><?php echo ' '; ?><?php endforeach; endif; unset($_from); ?><?php echo '" /><meta name="description" content="'; ?><?php echo $this->_tpl_vars['post']->title; ?><?php echo ','; ?><?php echo $this->_tpl_vars['next']->title; ?><?php echo ','; ?><?php echo $this->_tpl_vars['previous']->title; ?><?php echo '" /><meta name="author" content="4kychao" /><link rel="stylesheet" type="text/css" href="'; ?><?php echo $this->_tpl_vars['tpl_front']; ?><?php echo 'style.css" /><title>'; ?><?php echo $this->_tpl_vars['post']->title; ?><?php echo '</title></head><body><div id="wrapper"><div id="header"><div id="header-inner"><h1>blog.sk80.com</h1><div class="description">等我有钱了, 咱买棒棒糖, 买2 根, 1 根 你看着我吃, 另1根 我吃给你看。</div>'; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
