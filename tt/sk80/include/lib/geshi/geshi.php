...
class GeSHi {
     ...
     * @var string
     */
    var $overall_style = 'font-family:Andale Mono,Lucida Console,Monaco,fixed,monospace;';

    /**
     *  The style for the actual code
     * @var string
     */
    var $code_style = 'font: normal normal 1em/1.2em Andale Mono,Lucida Console,Monaco,fixed,monospace; margin:0; padding:0; background:none; vertical-align:top;';
