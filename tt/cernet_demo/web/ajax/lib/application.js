...
var jsApp = {
	 ...
	 * 返回值:void
	 */
	post:function(RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async)
	{
		jsApp.request(RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async, "post");
	},
	 ...
	 * 返回值:void
	 */
	get:function(RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async)
	{
		jsApp.request(RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async, "get");
	},
	 ...
	 * 返回值:void
	 */
	request:function(RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async, Method)
	{
		...
		if(!Async || Async != false || typeof Async == 'undefined') Async = true;
		if(!Method || typeof Method == 'undefined') Method = 'get';

		new Ajax.Request(jsApp.getway + RequestMod, {
			asynchronous: Async,
			method: Method,
	 ...
	 * 返回值:void
	 */
	updater:function(Element, RequestMod, RequestData, SuccessCall, FailureCall, WaitingCall,DisabledBtn, Async, Method)
	{
		//alert("debug:request start...");
		...
		new Ajax.Updater(Element, jsApp.getway + RequestMod, {
			asynchronous: Async,
			method: Method,
			parameters: "id="+RequestData,
			onSuccess: function(response) {
				jsApp.hide();
				try{
	...
	{
		jsApp.message("请求成功...", jsApp.msgType.SUCCESS);
	},
