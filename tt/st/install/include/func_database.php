	...
	function create_database($convert_version=FALSE)
	{
		...
		$res	= $res && my_mysql_query("
			CREATE TABLE `".$prefix."applications` (
			  ...
			  `consumer_key` varchar(250) collate utf8_unicode_ci NOT NULL default '',
			  `consumer_secret` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `callback_url` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `avatar` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `description` text collate utf8_unicode_ci,
			  `app_website` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `organization` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `website` varchar(100) collate utf8_unicode_ci NOT NULL default '',
			  `app_type` enum('','browser','client') collate utf8_unicode_ci NOT NULL default '',
			  `acc_type` enum('','r','rw') collate utf8_unicode_ci NOT NULL default '',
			  `use_for_login` tinyint(1) unsigned NOT NULL default '0',
			  `reg_date` int(10) unsigned NOT NULL default '0',
			  `reg_ip` bigint(10) unsigned NOT NULL default '0',
			  PRIMARY KEY  (`id`),
			  KEY `app_id` (`app_id`),
		...
		$res	= $res && my_mysql_query("
			CREATE TABLE `".$prefix."groups_rssfeeds` (
			  ...
			  `filter_keywords` varchar(255) collate utf8_unicode_ci NOT NULL,
		...
		$res	= $res && my_mysql_query("
			CREATE TABLE `".$prefix."users` (
			  `id` int(10) unsigned NOT NULL auto_increment,
			  `facebook_uid` varchar(32) collate utf8_unicode_ci NOT NULL default '',
			  `twitter_uid` varchar(32) collate utf8_unicode_ci NOT NULL default '',
			  ...
			  `num_posts` int(10) unsigned NOT NULL default '0',
			  `num_followers` int(10) unsigned NOT NULL default '0',
			  `used_storage` bigint(10) unsigned NOT NULL default '0',
			  ...
			  `reg_date` int(10) unsigned NOT NULL default '0',
			  `reg_ip` bigint(10) NOT NULL default '0',
			  `lastlogin_date` int(10) unsigned NOT NULL default '0',
			  `lastlogin_ip` bigint(10) NOT NULL default '0',
			  ...
			  `lastclick_date_newest_post` int(10) unsigned NOT NULL default '0',
			  `pass_reset_key` varchar(32) collate utf8_unicode_ci NOT NULL default '',
