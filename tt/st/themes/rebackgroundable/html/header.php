	...
	<body>
		<div id="headline">
			<div id="headline2">
				...
				<div id="headnav">			
					<a href="<?= $C->SITE_URL ?>" class="<?= $this->request[0]=='dashboard'||$this->request[0]=='home'?'onnav':'' ?>"><b>Home</b></a>			
					<?php if( $this->user->is_logged ) { ?>
					<a href="<?= $C->SITE_URL ?><?= $this->user->info->username ?>" class="<?= $this->request[0]=='user'&&$this->param('user')==$this->user->id?'onnav':'' ?>"><b>Profile</b></a>			
					<?php } else { ?>		 				
		...
		<div id="site">
			<div id="site2">
				...
				<?php if( $this->user->is_logged ) { ?>
				<div id="postform" style="display:none; margin-top:0; margin-bottom:10px;">
